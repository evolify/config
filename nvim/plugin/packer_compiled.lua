...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\n]\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\15signcolumn\1\23current_line_blame\2\nsetup\rgitsigns\frequire\0" },
    loaded = true,
  ...
  ["nvim-dap"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/evolify/.local/share/nvim/site/pack/packer/opt/nvim-dap"
  },
  ["nvim-dap-ui"] = {
    after = { "nvim-dap" },
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/evolify/.local/share/nvim/site/pack/packer/opt/nvim-dap-ui"
  },
  ["nvim-lspconfig"] = {
  ...
  ["vim-signature"] = {
    loaded = true,
    path = "/Users/evolify/.local/share/nvim/site/pack/packer/start/vim-signature"
  },
  ["vim-surround"] = {
    loaded = true,
...
-- Conditional loads
time("Condition for { 'telescope.nvim' }", true)
if
try_loadstring("\27LJ\2\n\21\0\0\1\1\0\0\3-\0\0\0\19\0\0\0L\0\2\0\2À\0", "condition", '{ "telescope.nvim" }')
then
time("Condition for { 'telescope.nvim' }", false)
